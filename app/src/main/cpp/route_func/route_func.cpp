...
//const unsigned char
//        shellcode_hooking_func[] = {0xFD, 0x7B, 0xBF, 0xA9, 0xE8, 0x27, 0xBF, 0xA9, 0x88, 0x88,
//                                    0x88, 0xF2, 0x68, 0x66, 0xA6, 0xF2, 0x48, 0x44, 0xC4, 0xF2,
//                                    0x28, 0x22, 0xE2, 0xF2, 0xE9, 0x83, 0, 0x91, 0xE8, 0x27, 0xBF,
//                                    0xA9, 0x88, 0x88, 0x88, 0xF2, 0x68, 0x66, 0xA6, 0xF2, 0x48,
//                                    0x44, 0xC4, 0xF2, 0x28, 0x22, 0xE2, 0xF2, 0, 1, 0x3F, 0xD6,
//                                    0xFF, 0x43, 0, 0x91, 0xE8, 0x27, 0xC1, 0xA8, 0xFD, 0x7B, 0xC1,
//                                    0xA8, 0xC0, 3, 0x5F, 0xD6
//};

const unsigned char
        shellcode_hooking_func[] = {0xFD, 0x7B, 0xBF, 0xA9, 0xE8, 0x27, 0xBF, 0xA9, 0x88, 0x88,
                                    0x88, 0xF2, 0x68, 0x66, 0xA6, 0xF2, 0x48, 0x44, 0xC4, 0xF2,
                                    0x28, 0x22, 0xE2, 0xF2, 0xE9, 0x83, 0, 0x91, 0xFE, 0x7B, 0xBF,
                                    0xA9, 0xE8, 0x27, 0xBF, 0xA9, 0x88, 0x88, 0x88, 0xF2, 0x68,
                                    0x66, 0xA6, 0xF2, 0x48, 0x44, 0xC4, 0xF2, 0x28, 0x22, 0xE2,
                                    0xF2, 0, 1, 0x3F, 0xD6, 0xFF, 0x83, 0, 0x91, 0xE8, 0x27, 0xC1,
                                    0xA8, 0xFD, 0x7B, 0xC1, 0xA8, 0xC0, 3, 0x5F, 0xD6};
...
unsigned char *create_shellcode_hooking_func(new_pfunc_t new_pfunc, void *context) {
    ...
    //new_pfunc
    patch_movk(&shell_code[36], GET_BIT(uint64_t, new_pfunc, 0, 16));
    patch_movk(&shell_code[40], GET_BIT(uint64_t, new_pfunc, 16, 16));
    patch_movk(&shell_code[44], GET_BIT(uint64_t, new_pfunc, 32, 16));
    patch_movk(&shell_code[48], GET_BIT(uint64_t, new_pfunc, 48, 16));
